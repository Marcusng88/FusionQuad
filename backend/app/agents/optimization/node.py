"""Optimization node - generates BESS dispatch plans via the MILP solver."""
...
def optimization_node(state: AgentState) -> dict:
    ...
    input_data = OptimizationInput(
        ...
        md_limit_kw=state.get("md_limit_kw") or 800.0,
        current_dispatch_index=state.get("current_dispatch_index") or 0,
